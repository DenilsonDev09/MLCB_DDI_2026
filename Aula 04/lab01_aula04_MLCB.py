...
for i in range(1, 11):
    ...
    if maior_prob >= LIMIAR_CONFIANCA:
          ...
          if intencao == "vendas":
              ...
              print("comente qual sua duvida que o suporte ja vai te atender")
          elif intencao == "trocas_devolucoes":
              print("me passe o codigo do pedido")
          elif intencao == "reclamacoes":
              print("desculpa pelo transtorno, iremos encaminhar sua reclamação para o Denilson do TI")
